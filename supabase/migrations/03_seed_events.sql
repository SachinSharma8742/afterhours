...
VALUES
  (
    ...
    '11111111-1111-1111-1111-111111111111',
    '👨 Boys Pass',
    'Valid entry pass for 1 male attendee (18+). Includes entry to all event activities and the DJ Night.',
    999.00,
    300,
    0,
    true
  ...
  (
    ...
    '11111111-1111-1111-1111-111111111111',
    '👩 Girls Pass',
    'Valid entry pass for 1 female attendee (18+). Includes entry to all event activities and the DJ Night.',
    299.00,
    300,
    0,
    true
  ...
  (
    ...
    '11111111-1111-1111-1111-111111111111',
    '💑 Couple Pass',
    'Valid entry pass for 1 couple (18+). Includes entry to all event activities and the DJ Night for both.',
    499.00,
    200,
    0,
    true
